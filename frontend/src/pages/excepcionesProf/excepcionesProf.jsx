...
const ExcepcionesProf = () => {
  ...
  const fetchExcepciones = async () => {
    try {
      const res = await API.get(`/excepcionesProf`);
  ...
  const guardarExcepcion = async () => {
    try {
      await API.post(`/excepcionesProf`, form);
  ...
  const eliminarExcepcion = async (idprofesional, dia_inicio) => {
    try {
      await API.delete(`/excepcionesProf/${idprofesional}/${dia_inicio}`);
  ...
  const actualizarExcepcion = async () => {
    try {
      ...
      await API.put(`/excepcionesProf/${registroActual.idprofesional}/${registroActual.dia_inicio}`, form);
